...
set layer_M5 [$tech findLayer M5]
set layer_M6 [$tech findLayer M6]
set layer_M7 [$tech findLayer M7]
...
fastroute -output_file $RESULT_PATH/route.guide \
          ...
          -layers_adjustments {{6 0.75} {7 0.5}} \
          -verbose 2
